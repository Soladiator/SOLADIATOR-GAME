...
const Blacksmith: React.FC<BlacksmithProps> = ({ items, onDrop, mode }) => {
  ...
  return (
    <div className='border rounded-xl p-4 bg-black bg-opacity-70'>
      <div className="text-center text-white text-3xl">Blacksmith</div>
      <Image className='w-1/2 flex mx-auto my-10' src={"/merchants/blacksmith.png"} alt='' width={1000} height={1100}></Image>
